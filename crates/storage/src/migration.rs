...
fn migrations() -> Vec<Migration> {
    vec![
        ...
        Migration {
            version: 7,
            description: "audit policy rules + budget settings (M4/M5)",
            sql: crate::schema::SCHEMA_V7,
        },
        Migration {
            version: 8,
            description: "generic app settings (sync throttle timestamps)",
            sql: crate::schema::SCHEMA_V8,
        },
        Migration {
            version: 9,
        ...
        Migration {
            version: 11,
            description: "audit finding disposition states (ignore/false-positive whitelist)",
            sql: crate::schema::SCHEMA_V11,
        },
        Migration {
            version: 12,
        ...
        Migration {
            version: 14,
            description: "saved searches (plan §13.2)",
            sql: crate::schema::SCHEMA_V14,
        },
    ]
}

...
const STEPS: Step[] = [
  {
    icon: "📥",
    title: "导入你的 AI 工具对话",
    body: "点左上角的「+ 导入」按钮，把 Cursor / Claude Code / ZCode / Codex 里的历史对话同步进 Threadock，统一管理。",
...
export default function OnboardingTour({ onClose, startStep = 0 }: { onClose: () => void; startStep?: number }) {
    ...
    <div className="settings-backdrop" onClick={finish}>
      ...
      >
        <div className="settings-header">
          <h2>
            <span style={{ marginRight: 6 }}>{cur.icon}</span>
            欢迎使用 Threadock
          </h2>
